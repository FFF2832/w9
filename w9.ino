...
// SSID & Password
const char* ssid="FFF";
const  char* password="canada1128";
    ...
    <head>\
      <style>\
        body{ display: flex; flex-direction: column;}\
         a { background:#ff8c00; width: 200px; height: 50px; margin: 20px; font-size: 30pt; text-decoration: none;}\
      </style>\
    </head>\
    <body>\
  ...
  <!DOCTYPE html>\
   <html>\
    <head>\
      <style>\
        body{ display: flex; flex-direction: column;}\
        a { background: #e0ffff; width: 200px; height: 50px; margin: 20px; font-size: 30pt; text-decoration: none;}\
      </style>\
    </head>\
    <body>\
      <h2>LED CLOSE</h2>\
